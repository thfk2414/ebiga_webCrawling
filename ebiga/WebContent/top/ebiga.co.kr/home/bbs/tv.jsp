...
<title>TV 1 페이지 | 이비가짬뽕</title>
<link rel="stylesheet"
	href="https://ebiga.co.kr/home/css/default.css?ver=161020">
<link rel="stylesheet"
	href="https://ebiga.co.kr/home/skin/board/video/style.css?ver=161020">
	...
	<div id="container">
		...
		<div id="sub" class="bbs">
			...
			<h2 id="container_title">
				TV<span class="sound_only"> 목록</span>
			</h2>
			...
			<div id="bo_gall" style="width: 100%">
				...
				<form name="fboardlist" id="fboardlist"
					...
					<input type="hidden" name="bo_table" value="tv"> <input
					...
					<ul id="gall_ul">
						<li class="gall_li "><span class="sound_only"> 20 </span>
							<ul class="gall_con">
								<li class="gall_href"><a
									href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=tv&amp;wr_id=37">
										<img src='http://img.youtube.com/vi/mqdefault.jpg'
										width='100%' height='auto' />
								</a></li>
								<li class="gall_text_href"><a
									href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=tv&amp;wr_id=37">
										TJB 당신의한끼 59회 - 짬뽕달인 권혁남의 민물매운탕 </a></li>
								<!-- <li><span class="gall_subject">작성자 </span><span class="sv_member">최고관리자</span></li>
                <li><span class="gall_subject">조회수 </span>323</li>
                <li><span class="gall_subject">작성일 </span>08-17</li> -->
			...
			<nav class="pg_wrap">
				<span class="pg"><span class="sound_only">열린</span><strong
					...
					href="./board.jsp?bo_table=tv&amp;page=2" class="pg_page">2<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=tv&amp;page=2" class="pg_page pg_end">맨끝</a>
				</span>
			</nav>
			<!-- 게시물 검색 시작 { -->
			<fieldset id="bo_sch">
