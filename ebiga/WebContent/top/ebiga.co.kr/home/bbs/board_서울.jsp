					...
					<fieldset id="bo_sch">
						...
						<form name="fsearch" method="get">
							<input type="hidden" name="bo_table" value="store"> <input
								type="hidden" name="sca" value="서울" id="sca"> <input
            ...
            <span>Total 건</span>
             페이지
				...
				<form name="fboardlist" id="fboardlist"
					...
					<ul id="mobile_list">
						<li>
							<div class="subject">강서 홈플러스점</div>
							<div class="address">서울 강서구 화곡로 398. 1층</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:02-2660-8000">02-2660-8000</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=145&amp;sca=%EC%84%9C%EC%9A%B8"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">영등포 오목교점</div>
							<div class="address">서울특별시 영등포구 영등포로 33 목동 비즈타워 1층 101호</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:02-2634-2582">02-2634-2582</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=139&amp;sca=%EC%84%9C%EC%9A%B8"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">롯데월드몰점</div>
							<div class="address">서울시 송파구 올림픽로 300 롯데월드몰 B1 푸드캐피탈 왕궁</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:02-3213-4788">02-3213-4788</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=138&amp;sca=%EC%84%9C%EC%9A%B8"
							class="detail">MAP</a>
						</li>
					</ul>
