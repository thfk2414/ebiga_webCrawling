					...
					<fieldset id="bo_sch">
						...
						<form name="fsearch" method="get">
							<input type="hidden" name="bo_table" value="store"> <input
								type="hidden" name="sca" value="대구" id="sca"> <input
            ...
            <span>Total 건</span>
             페이지
				...
				<form name="fboardlist" id="fboardlist"
					...
					<ul id="mobile_list">
						<li>
							<div class="subject">대구 성서점</div>
							<div class="address">대구광역시 달서구 달서대로 467</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:053-588-1554">053-588-1554</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=155&amp;sca=%EB%8C%80%EA%B5%AC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">대구 칠곡점</div>
							<div class="address">대구광역시 북구 칠곡중앙대로 643. 1층</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:053-313-0101">053-313-0101</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=123&amp;sca=%EB%8C%80%EA%B5%AC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">대구 지산점</div>
							<div class="address">대구 수성구 무학로 183</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:053-287-3444">053-287-3444</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=94&amp;sca=%EB%8C%80%EA%B5%AC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">대구 범어점</div>
							<div class="address">대구 수성구 국채보상로 947 (만촌동 421-15)</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:053-744-1107">053-744-1107</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=63&amp;sca=%EB%8C%80%EA%B5%AC"
							class="detail">MAP</a>
						</li>
					</ul>
