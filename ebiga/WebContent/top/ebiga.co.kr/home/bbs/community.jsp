	...
	<div id="container">
		...
		<div id="sub" class="bbs">
			...
			<h2 id="container_title">
				고객의소리<span class="sound_only"> 목록</span>
			</h2>
			...
			<div id="bo_list" style="width: 100%">
				...
				<div class="bo_fx">
					<div id="bo_list_total">
						<span>Total 338건</span> 1 페이지
					</div>

					<ul class="btn_bo_user">
						<li><a href="./write.jsp?bo_table=community" class="btn_b02">글쓰기</a></li>
					</ul>
				</div>
				<!-- } 게시판 페이지 정보 및 버튼 끝 -->
							...
							<thead>
								<tr>
									...
									<th scope="col" class="td_date"><a
										href="/home/bbs/board.jsp?bo_table=community&amp;sop=and&amp;sst=wr_datetime&amp;sod=desc&amp;sfl=&amp;stx=&amp;sca=&amp;page=1">날짜</a></th>
									<th scope="col" class="td_view"><a
										href="/home/bbs/board.jsp?bo_table=community&amp;sop=and&amp;sst=wr_hit&amp;sod=desc&amp;sfl=&amp;stx=&amp;sca=&amp;page=1">조회</a></th>
								</tr>
							</thead>
							<tbody>
								<tr class="">
									...
									<td class="td_subject"><a
										href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=community&amp;wr_id=532">
											부산 미남사직점 </a> <img
										src="https://ebiga.co.kr/home/skin/board/basic/img/icon_secret.gif"
										alt="비밀글"></td>
									<td class="td_name sv_use"><span class="sv_member">얌얌이</span></td>
									<td class="td_date">11-06</td>
									<td class="td_num  td_view">11</td>
								</tr>


								<tr class="">
									<td class="td_num">329</td>
									<td class="td_subject"><img
										src="https://ebiga.co.kr/home/skin/board/basic/img/icon_reply.gif"
										style="margin-left: 10px;" alt="답변글"> <a
										href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=community&amp;wr_id=526">
											Re: 송정이비가 너무 비위생적 </a> <img
										src="https://ebiga.co.kr/home/skin/board/basic/img/icon_secret.gif"
										alt="비밀글"></td>
									<td class="td_name sv_use"><span class="sv_member">최고관리자</span></td>
									<td class="td_date">10-10</td>
									<td class="td_num  td_view">5</td>
								</tr>
							</tbody>
						</table>
					</div>
			...
			<nav class="pg_wrap">
				<span class="pg"><span class="sound_only">열린</span><strong
					...
					href="./board.jsp?bo_table=community&amp;page=2" class="pg_page">2<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=3" class="pg_page">3<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=4" class="pg_page">4<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=5" class="pg_page">5<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=6" class="pg_page">6<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=7" class="pg_page">7<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=8" class="pg_page">8<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=9" class="pg_page">9<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=10" class="pg_page">10<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=community&amp;page=11"
					class="pg_page pg_next">다음</a> <a
					href="./board.jsp?bo_table=community&amp;page=34"
