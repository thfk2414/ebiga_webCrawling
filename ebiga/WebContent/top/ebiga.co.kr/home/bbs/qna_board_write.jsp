		...
		<div id="view_all" class="view_all">
			<div id="writebox" class="writebox">
				<table align="center" width="700px" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td align="center" height="50px"><b>글쓴이</b></td>
						<td style="width: 500px;"><input type="text"
							name="BOARD_NAME" style="width: 500px; height: 50px;"></td>
					</tr>
					...
					<tr>
						...
						<td style="width: 500px;"><textarea name="BOARD_CONTENT"
								rows="20" style="width: 500px; height: 500px;"></textarea></td>
					</tr>
				</table>
			</div>
			<br>
			<div align="right">
				<a href="javascript:addboard()" class="btn_b01"
					style="background-color: rgba(220, 220, 220, 0.3);">등록</a>&nbsp;&nbsp;
