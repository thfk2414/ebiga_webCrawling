...
<title>2018 추석 휴무 안내 > 공지사항-상세정보 | 이비가짬뽕</title>
<link rel="stylesheet"
...
<body>
	...
	<div id="container">
		...
		<div id="sub" class="bbs">
			...
			<script src="https://ebiga.co.kr/home/js/viewimageresize.js"></script>
			...
			<article id="bo_v" style="width: 100%">
				<header>
					<h1 id="bo_v_title"><%=board.getBOARD_SUBJECT()%></h1>
				</header>

				<section id="bo_v_info">
					<h2>페이지 정보</h2>
					작성자 <strong><span class="sv_member"><%=board.getBOARD_NAME()%></span></strong>
					<span class="sound_only">작성일</span><strong><%=board.getBOARD_DATE()%></strong>
					조회<strong><%=board.getBOARD_READCOUNT()%></strong>
				</section>
 ...
 %>
				...
				<script src="https://ebiga.co.kr/home/js/md5.js"></script>

				<!-- 링크 버튼 시작 { -->
				<div id="bo_v_bot">
					<ul class="bo_v_com">
						<li><a href="./BoardList.bo" class="btn_b01">목록</a></li>&nbsp;&nbsp;




						<li><a href="javascript:history.go(-1)" class="btn_b01">돌아가기</a>
						<li>
							<div>
								<%
									if (id == null) {
								...
								<ul class="bo_v_com">
									<li><a
										href="./BoardModify.bo?num=<%=board.getBOARD_NUM()%>"
										class="btn_b01">수정 </a></li>&nbsp;&nbsp;

									<li><a
										href="./BoardDeleteAction.bo?num=<%=board.getBOARD_NUM()%>"
										class="btn_b01">삭제</a></li>&nbsp;&nbsp;
								</ul>
								<%
									}
								%>
