				...
				<div id="map_right_wrapper">
					...
					<form name="fcategory" id="fcategory" method="get">
						<nav id="bo_cate">
							<h2>매장안내 카테고리</h2>
							<ul id="bo_cate_ul">
								<li><a href="./top/ebiga.co.kr/home/bbs/seoul.search">서울</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/incheon.search">인천</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/daejeon.search">대전</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/Gwangju.search">광주</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/daegu.search">대구</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/busan.search">부산</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/ulsan.search">울산</a></li>
								<li><a href="./top/ebiga.co.kr/home/bbs/jeju.search">제주</a></li>
							</ul>
						</nav>
					</form>
					<!-- } 게시판 카테고리 끝 -->
					...
					<div align="center">
						...
						<div>
							...
							<%
									...
									System.out.println(session.getAttribute("idSession") + "지점 등록하기");
							%>
						</div>
						<br>
					</div>
					<form name="fsearch" method="get" action="select.search">
						<nav id="bo_cate">
							<h2>지점 추가</h2>
							지점명<input type="text" name="storename" required
								class="frm_input required" size="15" maxlength="15"> 연락처<input
								type="text" name="phone" required class="frm_input required"
								size="15" maxlength="15"> 주소<input type="text"
								name="Address" required class="frm_input required" size="15"
								maxlength="15"> <input type="submit" value="추가"
								class="btn_submit">
						</nav>
					</form>
					<%
					...
					<fieldset id="bo_sch">
						...
						<form name="fsearch" method="get" action="select.search">
							<input type="hidden" name="bo_table" value="store"> <input
								type="hidden" name="sca" value="" id="sca"> <input
								...
								class="sound_only"> 필수</strong></label> <input type="text" name="ctx"
             ...
             페이지
				...
				<form name="fboardlist" id="fboardlist"
					...
					<ul id="mobile_list">
						...
						%>
						<li>
							<div class="subject"><%=search.getBRANCHNAME()%></div>
							<div class="address"><%=search.getTEL()%></div>
							<div class="phone"><%=search.getADDRESS()%></div>
						</li>
						<%
							}
						%>
