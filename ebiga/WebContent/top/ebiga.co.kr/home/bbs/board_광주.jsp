			...
			<div id="bo_list" style="width: 100%">
				...
				<div id="map_right_wrapper">
					...
					<fieldset id="bo_sch">
						...
						<form name="fsearch" action="select.search" method="get">
							<input type="hidden" name="bo_table" value="store"> <input
								type="hidden" name="sca" value="광주" id="sca"> <input
								type="hidden" name="sop" value="and"> <label for="sfl"
								class="sound_only">검색대상</label> <select name="sfl" id="sfl">
								<option name="storeName" value="wr_subject">지점명</option>
								<option name="address" value="wr_2">주소</option>
            ...
            <span>Total 건</span>
             페이지
				...
				<form name="fboardlist" id="fboardlist"
					...
					<ul id="mobile_list">
						<li>
							<div class="subject">광주 평동점</div>
							<div class="address">광주시 광산구 동곡로 382</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-944-3778">062-944-3778</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=147&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 전남대점</div>
							<div class="address">광주 북구 용봉로 10</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-511-5576">062-511-5576</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=114&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 두암점</div>
							<div class="address">광주 북구 필문대로 101</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-434-1999">062-434-1999</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=105&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 상무점</div>
							<div class="address">광주 서구 천변좌하로 266</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-375-8588">062-375-8588</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=97&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 양산점</div>
							<div class="address">광주 북구 하서로 330</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-574-4433">062-574-4433</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=86&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 풍암 호수점</div>
							<div class="address">광주 서구 풍암신흥로 97</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-654-5676">062-654-5676</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=80&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 효천진월점</div>
							<div class="address">광주 남구 효덕로 192 (노대동 814)2층</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-672-9066">062-672-9066</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=73&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 첨단점</div>
							<div class="address">광주 광산구 쌍암동 673-1</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-974-9333">062-974-9333</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=65&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
						<li>
							<div class="subject">광주 수완점</div>
							<div class="address">광주 광산구 수완동 762</div>
							<div class="phone">
								<i class="fa fa-phone-square" aria-hidden="true"></i><a
									href="tel:062-952-1775">062-952-1775</a>
							</div> <a
							href="https://ebiga.co.kr/home/bbs/board.php?bo_table=store&amp;wr_id=55&amp;sca=%EA%B4%91%EC%A3%BC"
							class="detail">MAP</a>
						</li>
					</ul>
