...
<title>언론 1 페이지 | 이비가짬뽕</title>
<link rel="stylesheet"
	href="https://ebiga.co.kr/home/css/default.css?ver=161020">
<link rel="stylesheet"
	href="https://ebiga.co.kr/home/skin/board/webzin/style.css?ver=161020">
	...
	<div id="container">
		...
		<div id="sub" class="bbs">
			...
			<h2 id="container_title">
				언론<span class="sound_only"> 목록</span>
			</h2>
			...
			<div id="bo_list" style="width: 100%">
				...
				<form name="fboardlist" id="fboardlist"
					...
					<input type="hidden" name="bo_table" value="media"> <input
							...
							<tbody class="bo_tr">
								...
								<tr>
									<td>
										<div class="img_area">
											<a
												href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=media&amp;wr_id=50"
												title="이비가짬뽕, 볶음짬뽕 출시기념 이벤트 시상식 진행"> <img
												src="https://ebiga.co.kr/home/data/file/media/thumb-1893614546_DYWpXc1o_c481f2f2ac1375ae0d16d224cb7af358f12e44a5_200x140.jpg"
												alt="" width="200" class="img_style" />
										</div> </a>
										<div class="text_area">
											<ul>
												<li class="js_tit"><a
													href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=media&amp;wr_id=50">이비가짬뽕,
														볶음짬뽕 출시기념 이벤트 시상식 진행</a>&nbsp;&nbsp;</li>
												<li class="js_info"><span class="sv_member">최고관리자</span>&nbsp;&nbsp;
													2017-08-21 15:43:16&nbsp;&nbsp;
													679회&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</li>
												<li class="js_con  detail_btn"><a
													href="https://ebiga.co.kr/home/bbs/board.jsp?bo_table=media&amp;wr_id=50">자세히보기</a></li>
			...
			<nav class="pg_wrap">
				<span class="pg"><span class="sound_only">열린</span><strong
					...
					href="./board.jsp?bo_table=media&amp;page=2" class="pg_page">2<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=media&amp;page=3" class="pg_page">3<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=media&amp;page=4" class="pg_page">4<span
						class="sound_only">페이지</span></a> <a
					href="./board.jsp?bo_table=media&amp;page=4" class="pg_page pg_end">맨끝</a>
				</span>
			</nav>
			<!-- 게시판 검색 시작 { -->
			<fieldset id="bo_sch">
...
form .agree .agree_content p {
	...
	<div id="footer">
		<div id="bottom">
			<ul class="sns">
				<li><a href="index.member"><img src="../image/f_home.png"
						alt="홈"></a></li>
			...
			<ul class="link">
				...
				<li><a href="search.bbs">오시는길</a></li>
				<li><a href="#">창업문의</a></li>
			</ul>
			<p class="address">
