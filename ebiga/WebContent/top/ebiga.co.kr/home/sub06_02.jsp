...
<body>
	...
	<div id="container">
		...
		<div class="story02_top">
			<h2 class="title">
				“음식은 <span>건강</span>이고 <span>과학</span>이며 <span>예술</span>이다.”
			</h2>
		</div>

		<div id="sub" class="story02">
			<p class="text">
				<b>1905년, 대한민국 최초 중국식당이 문을 연 후, <br>짬뽕은 국내 중국 음식의 대명사가
					되었으며, 남녀노소 모두에게 인기있는 음식으로 자리를 잡았습니다.
				</b><br> <br> <img src="./image/story02_img01.jpg" alt=""><br>
				<br> 이비가는 100여년간 우리나라 국민의 사랑을 받아온 짬뽕이 한식과 자연스럽게 어우러질 수 있도록 연구를
				거듭한 끝에<br> <b><span>사골과 토종닭, 한약재</span>를 넣어 푹 고아 만든 육수로 한국
					최초 짬뽕국물 제조 특허</b>를 받았으며,<br> 단순한 중국음식 짬뽕이 아닌 짬뽕전문점 이비가짬뽕으로 한국식 짬뽕의
				새로운 역사를 열어가고 있습니다. <br> 이비가짬뽕을 드셔 본 분들이 모두 인정하는 그 ‘맛’ 하나로 입소문을
				타기 시작했고, 간단한 음식이 아닌 제대로된 한끼 식사로 만들어져 지난 100년의 역사를 뒤로하고,<br>
				앞으로의 짬뽕역사 100년을 이끌어갈 대한민국 대표 짬뽕 맛집으로 나아갈 것입니다.
			</p>
